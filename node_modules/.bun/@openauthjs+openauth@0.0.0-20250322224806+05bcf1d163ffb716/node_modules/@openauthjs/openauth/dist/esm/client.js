  ...
  const result = {
    ...
    async verify(token, options) {
      ...
      try {
        ...
        let properties = result2.payload.properties;
        if (input.subjects) {
          const schema = input.subjects[result2.payload.type];
    ...
    decode(token) {
      try {
        ...
        if (!payload || typeof payload.type !== "string" || typeof payload.sub !== "string") {
