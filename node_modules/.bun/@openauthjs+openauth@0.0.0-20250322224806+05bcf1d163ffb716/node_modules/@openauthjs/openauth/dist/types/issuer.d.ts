...
export interface OnSuccessResponder<T extends {
     ...
     */
    subject<Type extends T["type"]>(type: Type, id: string, properties: [Extract<T, {
        type: Type;
    }>["properties"]] extends [never] ? Record<string, any> : Extract<T, {
        type: Type;
    }>["properties"], opts?: {
        ttl?: {
            access?: number;
...
export interface IssuerInput<Providers extends Record<string, Provider<any>>, Subjects extends SubjectSchema = SubjectSchema, Result = {
