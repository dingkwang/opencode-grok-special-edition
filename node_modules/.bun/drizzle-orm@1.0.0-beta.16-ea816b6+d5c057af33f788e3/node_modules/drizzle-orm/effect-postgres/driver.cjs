...
const make = effect_Effect.fn("PgDrizzle.make")(function* (config = {}) {
	...
	const db = new EffectPgDatabase(dialect, new require_effect_postgres_session.EffectPgSession(client, dialect, relations, schema, logger, cache), relations, schema);
	db.$client = client;
	db.$cache = cache;
